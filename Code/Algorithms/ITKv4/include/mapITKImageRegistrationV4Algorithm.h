...
#ifndef __ITK_IMAGE_REGISTRATION_V4_ALGORITHM_H
#define __ITK_IMAGE_REGISTRATION_V4_ALGORITHM_H
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			/*! @class ITKImageRegistrationV4Algorithm
			@brief The class is used for image registration v4 algorithm based on ITK.
			...
			*/
			template < class TMovingImage, class TTargetImage,
					 ...
					 class TMetricPolicy = ArbitraryObjectToObjectMetricPolicy<TMovingImage, TTargetImage>,
					 class TOptimizerPolicy = ArbitraryObjectToObjectOptimizerPolicy,
					 ...
					 ::itk::ImageRegistrationMethodv4<TTargetImage, TMovingImage> >
