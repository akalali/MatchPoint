...
#ifndef __ARBITRARY_OBJECT_TO_OBJECT_METRIC_POLICY_TPP
#define __ARBITRARY_OBJECT_TO_OBJECT_METRIC_POLICY_TPP
...
namespace map
{
	namespace algorithm
	{
		namespace itk
		{
			...
			unsigned long
			ArbitraryObjectToObjectMetricPolicy<TMovingImage, TTargetImage>::
			GetMTime() const
			{
			...
			template<class TMovingImage, class TTargetImage>
			typename ArbitraryObjectToObjectMetricPolicy<TMovingImage, TTargetImage>::MetricControlType*
			ArbitraryObjectToObjectMetricPolicy<TMovingImage, TTargetImage>::
			getMetricInternal()
			{
				return _spMetric;
			...
			template<class TMovingImage, class TTargetImage>
			const typename ArbitraryObjectToObjectMetricPolicy<TMovingImage, TTargetImage>::MetricControlType*
			ArbitraryObjectToObjectMetricPolicy<TMovingImage, TTargetImage>::
